...
CREATE TABLE `User` (
    ...
    `isContributor` BOOLEAN NULL DEFAULT false,
...
CREATE TABLE `EBook` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `name` VARCHAR(191) NOT NULL,
    `category` ENUM('fiction', 'economics', 'philosophy', 'professional', 'non_fiction', 'biography', 'other') NULL DEFAULT 'other',
    `words` INTEGER NULL,
