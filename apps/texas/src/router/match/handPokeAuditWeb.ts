...
import { HAND_POKE_AUDIT_MIN_VALID_HANDS } from './handPokeAuditConstants'
import {
 ...
 */
router.post(matchWebApi('/hand-poke-audit/list'), async (ctx) => {
...
router.post(matchWebApi('/hand-poke-audit/detail'), async (ctx) => {
  ...
  response.success(ctx, {
    ...
    heatmapScaleEnabled: agg.validHandCount >= HAND_POKE_AUDIT_MIN_VALID_HANDS,
    pokeDistribution
  })
})
